...
public class CustomizationHandler : MonoBehaviour {
    ...
    void OnMouseDown()
    {
        ...
        if (MainGameHandler.selectedItemInInventory.GetComponent<ItemData>().itemType.Equals(ItemData.ItemTypes.HatPanel))
        {
            ...
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.MoonJelly)) attachPoint = moonjellyfishHatPoint;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.BottleNose)) attachPoint = bottlenoseHatPoint;
        ...
        if (MainGameHandler.selectedItemInInventory.GetComponent<ItemData>().itemType.Equals(ItemData.ItemTypes.GunPanel))
        {
            ...
            Vector2 attachPoint = Vector2.zero;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.MoonJelly)) attachPoint = moonjellyfishGunPoint;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.BottleNose)) attachPoint = bottlenoseGunPoint;
        ...
        if (MainGameHandler.selectedItemInInventory.GetComponent<ItemData>().itemType.Equals(ItemData.ItemTypes.EyepiecePanel))
        {
            ...
            Vector2 attachPoint = Vector2.zero;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.MoonJelly)) attachPoint = moonjellyfishEyePoint;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.BottleNose)) attachPoint = bottlenoseEyePoint;
        ...
        if (MainGameHandler.selectedItemInInventory.GetComponent<ItemData>().itemType.Equals(ItemData.ItemTypes.MouthpiecePanel))
        {
            ...
            Vector2 attachPoint = Vector2.zero;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.MoonJelly)) attachPoint = moonjellyfishMouthPoint;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.BottleNose)) attachPoint = bottlenoseMouthPoint;
        ...
        if (MainGameHandler.selectedItemInInventory.GetComponent<ItemData>().itemType.Equals(ItemData.ItemTypes.VestPanel))
        {
            ...
            Vector2 attachPoint = Vector2.zero;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.MoonJelly)) attachPoint = moonjellyfishVestPoint;
            if (MainGameHandler.type.Equals(MainGameHandler.CreatureTypes.BottleNose)) attachPoint = bottlenoseVestPoint;
